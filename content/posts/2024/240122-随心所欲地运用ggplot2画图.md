...
很久以前，我写过《[用ggplot2画迷宫](/2020/07/18/using-ggplot2-to-draw-mazes/)》和《[用ggplot2给娃手工做张九九乘法表](/2020/07/11/using-ggplot2-to-manually-make-a-multiplication-table-for-kids/)》，都属于不务正业地乱用 `ggplot2`。
